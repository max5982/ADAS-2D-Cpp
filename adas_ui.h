...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        Form->resize(3840, 2160);
        Form->setMaximumSize(QSize(3840, 2160));
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 3851, 1091));
        horizontalLayout = new QHBoxLayout(horizontalLayoutWidget);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        label_adas = new QLabel(horizontalLayoutWidget);
        label_adas->setObjectName(QString::fromUtf8("label_adas"));
        label_adas->setMaximumSize(QSize(1920, 16777215));

        horizontalLayout->addWidget(label_adas);
...
"color: white;"));
    ...
    {
        label_adas->setText(QCoreApplication::translate("Form", "TextLabel", nullptr));
